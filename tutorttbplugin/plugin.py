...
hooks.Filters.IMAGES_BUILD.add_items(
    [
        ...
        # you would add a Dockerfile to templates/ttbplugin/build/myimage,
        # and then write:
        ### (
        ###     "myimage",
...
### hooks.Filters.CLI_COMMANDS.add_item(ttbplugin)
...
#   $ tutor ttbplugin example-command
